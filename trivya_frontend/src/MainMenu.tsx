    ...
    <div className="pt-32">
      ...
      <div className="flex justify-center items-center m-auto w-11/12 sm:w-screen">
        <div className="grid grid-cols-3 gap-x-5 gap-y-3 place-items-center text-tertiary pt-14 w-screen">
          <button type="button" aria-label="Classic Mode" className="bg-primary rounded-lg cursor-pointer w-28 h-28 sm:w-40 sm:h-40">
          ...
          { isAdultMode && (
          <button type="button" aria-label="Adult Mode" className="bg-primary rounded-lg cursor-pointer w-28 h-28 sm:w-40 sm:h-40">
            <Link to="/number-of-teams">
          ...
          <button type="button" aria-label="Admin" className="bg-primary rounded-lg cursor-pointer w-28 h-28 sm:w-40 sm:h-40">
            <Link to="/admin">
